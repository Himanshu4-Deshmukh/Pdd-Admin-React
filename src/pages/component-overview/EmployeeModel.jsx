            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                <Grid container spacing={1}>
                  {[
                    { label: 'DASHBOARD', privileges: ['VIEW', 'ADD', 'EDIT'] },
                    { label: 'CUSTOMER MASTER', privileges: ['VIEW', 'ADD', 'EDIT'] },
                    { label: 'EMPLOYEE MASTER', privileges: ['VIEW', 'ADD', 'EDIT'] },
                    { label: 'USER MASTER', privileges: ['VIEW', 'ADD', 'EDIT'] },
                    { label: 'VEHICLE MASTER', privileges: ['VIEW', 'ADD', 'EDIT'] },
                    { label: 'ADMINISTRATOR MASTER', privileges: ['VIEW', 'ADD', 'EDIT'] },
                    { label: 'BULK DATA MASTER', privileges: ['YES'] },
                    { label: 'OTHER OPTION MASTER', privileges: ['YES'] }
                  ].map((item) => (
                    <Grid item xs={12} key={item.label}>
                      ...
                      {item.privileges.map((privilege) => (
                        <FormControlLabel
                          key={privilege}
                          control={<Checkbox name={privilege} />}
                          label={privilege}
                        />
                      ))}
                    </Grid>
